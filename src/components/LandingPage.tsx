import { Calendar, ChevronRight, MapPin, Phone, ShieldCheck, Wifi, Coffee, Compass, ExternalLink, Building2, type LucideIcon } from "lucide-react";
...
export default function LandingPage({ rooms, heroImageUrl, publicContent, onSelectRoom, onLoginClick, isLoggedIn }: LandingPageProps) {
  const policyCards: Array<{ key: keyof PublicPolicies; title: string; icon: LucideIcon }> = [
    ...
    { key: "selfCheckIn", title: "Llegada autónoma", icon: ShieldCheck },
  ];
